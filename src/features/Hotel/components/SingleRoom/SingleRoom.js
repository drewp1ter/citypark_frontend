...
const SingleRoom = ({ rooms: { single_rooms } }) =>
  <div className="light">
    ...
    <div className="room_info_block">
      ...
      <div className="room_summ" style={{position: "relative"}}><span className="summ">3000-3500</span> ₽/сутки</div>
    ...
    <div className="room_text">
      ...
      <p><span>&nbsp;</span></p>
      <h3><span>201 — одноместный номер с двуспальной кроватью, с балконом. Площадь 23 кв.м. + балкон 7 кв.м.<br/></span>Стоимость 3500 руб./сутки.</h3>
      <h3><br/><span>204, 304 — одноместные номера с двуспальной кроватью. Площадь 19 кв.м.&nbsp;<br/>Стоимость 3000 руб./сутки.<br/></span></h3>
      <p><span>&nbsp;</span></p>
