...
const DoubleRoom = ({ rooms: { double_rooms } }) =>
  <div className="light">
    ...
    <SocShare
      ...
      image={baseUrl() + images.double_room}
    />
    <div className="room_info_block">
      ...
      <div className="room_summ" style={{position: "relative"}}><span className="summ">4500</span> ₽/сутки</div>
    ...
    <div className="room_text">
      ...
      <h3>Двухместные номера в гостинице Сити Парк в Белореченске идеальны для проживания вдвоем.</h3>
      <p>&nbsp;</p>
...
const WrappedComponent = ReduxWrapper(DoubleRoom)
