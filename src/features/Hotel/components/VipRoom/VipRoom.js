...
const VipRoom = ({ rooms: {vip_room} }) =>
  <div className="light">
    ...
    <div className="room_text">
      <h1>VIP-номер</h1>
      <h3><span style={{fontSize: "1.17em", lineHeight: "1.5em"}}>VIP-номер в гостинице Сити Парк в Белореченске порадует вас простором и комфортом.</span></h3>
      <h3>Двухкомнатный номер с балконом. Площадь 45кв.м. + балкон 7кв.м.</h3>
      <p><br/><strong>1-я комната — гостиная.</strong><br/><strong>Комплектация:</strong> <br/>• диван-кровать;<br/>•&nbsp;камин электрический;<br/>•&nbsp;сплит-система;<br/>• Smart TV;<br/>•&nbsp;рабочий стол;<br/>•&nbsp;кресло;<br/>•&nbsp;журнальный
        столик;<br/>•&nbsp;пуфы.</p>
      <p><strong style={{lineHeight: "1.5em"}}>&nbsp;</strong></p>
      <p><strong style={{lineHeight: "1.5em"}}>2-я комната — спальня.</strong></p>
      <p><strong>Комплектация:</strong> <br/>•&nbsp;двуспальная кровать;<br/>•&nbsp;прикроватные тумбы;<br/>•&nbsp;сплит-система;<br/>• Smart TV;<br/>•&nbsp;шкаф-гардероб;<br/>•&nbsp;комод;<br/>•&nbsp;сейф;<br/>•&nbsp;холодильник;<br/>•&nbsp;журнальный
        столик;<br/>•&nbsp;внутренний телефон.</p>
      <p>&nbsp;</p>
      <p><strong>Санузел:</strong>&nbsp;душевая кабинка, фен, туалетные принадлежности.</p>
      <p>&nbsp;</p>
      <p><strong>На всей территории РГК Сити Парк доступен бесплатный&nbsp;Wi-fi&nbsp;</strong></p>
