...
export default () =>
  <div className="light">
    ...
    <p className="justifyleft">
      ...
      />
      <br/>
      В летнем кафе Сити Парк вы насладитесь восхитительными блюдами европейской и японской кухни от&nbsp;
    ...
    <h3 className="justifyleft">
      Забронировать столик или заказать доставку еды по Белореченску вы можете по телефону +7-918-311-97-91 или на сайте РГК Сити Парк <a title="РГК Сити Парк Белореченск. Доставка еды." href="https://cityparkvip.ru/">www.cityparkvip.ru</a> в разделе <Link to={MENU.URL}>"Меню"</Link>
    </h3>
    <PhotoGallery
      items={[
        {
