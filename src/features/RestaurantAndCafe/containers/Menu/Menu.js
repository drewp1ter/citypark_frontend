  ...
  render = () => {
    ...
    return (
      <div className="light restaraunt-menu">
        ...
        <h2>Доставка в соты и днт платная от 200 до 350р</h2>
        <h2>Заказы принимаются с 10:00 до 23:00 по телефону: <a href="tel:+79183119791">8-918-311-97-91</a>.<br/>&nbsp;</h2>
        <h2>&nbsp;</h2>
        <h4>Доставка еды в Белореченске от ресторана Сити Парк. <a href="tel:+79183119791">8-918-311-97-91</a>. <a target="_blank" rel="noopener noreferrer" href="https://cityparkvip.ru">www.cityparkvip.ru</a></h4>
        <p>&nbsp;</p>
        <p></p>
        { this.categoriesList() }
